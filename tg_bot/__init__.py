...
if ENV:
    ...
    try:
        B_USERS = set(int(x) for x in os.environ.get("B_USERS", "").split())
    except ValueError:
        raise Exception("Your B users list does not contain valid integers.")
    ...
    try:
        B_USERS = set(int(x) for x in Config.B_USERS or [])
    except ValueError:
        raise Exception("Your B users list does not contain valid integers.")
