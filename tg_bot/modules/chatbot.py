...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows Texas to talk back making your chat more interactive.
This is an ongoing upgrade and is only available in your chats if you reach out to @texassupport and ask for it. 

In future we might make it open for any chat and controllable by group admins.

Powered by CoffeeHouse (https://coffeehouse.intellivoid.net/) from @Intellivoid
Commands: These only work for Texas Staff users. 
