...
from tg_bot import dispatcher, DEL_CMDS, WHITELIST_USERS, B_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS


def is_whitelist_plus(chat: Chat, user_id: int, member: ChatMember = None) -> bool:
    return any(user_id in user for user in [WHITELIST_USERS, B_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS])
