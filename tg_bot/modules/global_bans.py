...
from tg_bot import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, SUPPORT_USERS, B_USERS, WHITELIST_USERS, STRICT_GBAN, GBAN_LOGS
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) in SUDO_USERS:
        message.reply_text("I spy, with my little eye... a tier! Why are you guys turning on each other?")
        return

    if int(user_id) in SUPPORT_USERS:
        message.reply_text("OOOH someone's trying to gban a Demon Tier! *grabs popcorn*")
        return

    if int(user_id) in B_USERS:
        message.reply_text("That's a B! They cannot be banned!")
        return
    ...
    try:
        bot.send_message(user_id,
                         ...
                         "If you think that this was a mistake, you may appeal your ban here: @texassupport",
                         parse_mode=ParseMode.HTML)
    except:
...
/gbanstat
Note: You can appeal gbans or ask gbans at @texassupport
"""
